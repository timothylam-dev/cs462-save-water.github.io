...
function get_reading_today(){
    ...
    xhr.open('GET', "https://cs462-t2.herokuapp.com/http://175.41.165.232:5000/watermeter_reading_by_date?date=" + today, false);
    xhr.send();
...
function get_monthly_readings() {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open('GET', "https://cs462-t2.herokuapp.com/http://175.41.165.232:5000/get_reading_by_month/" + current_month, false);
    xhr.send();
